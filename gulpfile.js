...
elixir(function(mix) {
    ...
    var assets = ["public/js/final.js", "public/css/final.css"],
        scripts = [
            "./public/js/vendor.js",
        ...
        styles = [
            ...
            "./public/css/fractionslider.css",
            "./public/css/style-fraction.css",
            "./public/css/app.css",
    ...
    mix.copy(fontsOutputFolder, buildPath + "/fonts");
});
