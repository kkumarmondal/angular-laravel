...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/pages/home/home.page.html',
    ...
    '          <span>\n' +
    '            <i class="fa fa-phone"></i>Phone: (123) 456-7890</span>\n' +
    '          <span>\n' +
    '            <i class="fa fa-envelope"></i>Email: mail@example.com</span>\n' +
    '        </div>\n' +
    '        <div class="col-sm-5 top-info">\n' +
    '          <ul>\n' +
    '            <li>\n' +
    '              <a href="" class="my-tweet">\n' +
    '                <i class="fa fa-twitter"></i>\n' +
    '              </a>\n' +
    '            </li>\n' +
    '            <li>\n' +
    '              <a href="" class="my-facebook">\n' +
    '                <i class="fa fa-facebook"></i>\n' +
    '              </a>\n' +
    '            </li>\n' +
    '            <li>\n' +
    '              <a href="" class="my-skype">\n' +
    '                <i class="fa fa-skype"></i>\n' +
    '              </a>\n' +
    '            </li>\n' +
    '            <li>\n' +
    '              <a href="" class="my-pint">\n' +
    ...
    '            <h1>\n' +
    '              <a href="/home">\n' +
    '                <img src="images/logo.png" alt="Eve" />\n' +
    '              </a>\n' +
    '            </h1>\n' +
    '          </div>\n' +
    '        </div>\n' +
    ...
    '\n' +
    '            <li>\n' +
    '              <a href="/home">Business Contact</a>\n' +
    '            </li>\n' +
    '\n' +
    '            <li>\n' +
    ...
    '      <div class="slide">\n' +
    '        <!--1- slide background-->\n' +
    '        <img src="images/fraction-slider/gadgets/laptop-lg.png" data-position="-30,550" data-in="bottom" data-delay="500" data-out="fade"\n' +
    ...
    '      </div>\n' +
    '      <div class="slide">\n' +
    '        <img src="images/fraction-slider/fraction_2.png" data-in="fade" data-delay="" data-out="fade" width="1920" height="auto">\n' +
    '        <!--2- slide background-->\n' +
    '\n' +
    '        <img src="images/fraction-slider/slider-boy.png" width="600" height="auto" data-position="8,1240" data-in="bottomLeft" data-delay="500"\n' +
    '          data-out="fade" style="width:auto; height:auto">\n' +
    '\n' +
    ...
    '      </div>\n' +
    '      <div class="slide">\n' +
    '        <img src="images/fraction-slider/build.png" data-in="fade" data-out="fade" width="1920" height="auto" />\n' +
    '        <!--3- slide background-->\n' +
    '\n' +
    ...
    '\n' +
    '        <img src="images/fraction-slider/gadgets/laptop.png" width="456" height="272" data-position="103,1180" data-in="bottom" data-out="bottom"\n' +
    '          data-delay="400">\n' +
    '\n' +
    '        <img src="images/fraction-slider/gadgets/mack.png" width="357" height="313" data-position="60,1040" data-in="top" data-out="bottom"\n' +
    '          data-delay="200">\n' +
    '\n' +
    '        <img src="images/fraction-slider/gadgets/ipad.png" width="120" height="170" data-position="230,1030" data-in="left" data-delay="300"\n' +
    '          data-out="left">\n' +
    '\n' +
    '        <img src="images/fraction-slider/gadgets/smartphone.png" width="70" height="140" data-position="270,1320" data-in="right"\n' +
    '          data-delay="300" data-out="right">\n' +
    '\n' +
    '        <div class="para-2" data-position="200,250" data-in="left" data-out="right" data-delay="3000">\n' +
    '          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad, aspernatur consequatur consequuntur debitis delectus nostrum\n' +
    '          quam quod reiciendis sit!\n' +
    '        </div>\n' +
    '\n' +
    '        <a href="" class="slider-read" data-position="360,250" data-in="bottom" data-out="Right" data-delay="3500">Free Download</a>\n' +
    '      </div>\n' +
    '      <div class="slide">\n' +
    '        <img src="images/fraction-slider/fraction_6.png" data-in="fade" data-out="fade" width="1920" height="auto">\n' +
    '        <!--4- slide background-->\n' +
    '\n' +
    ...
    '\n' +
    '        <img src="images/fraction-slider/slider-girl.png" width="480" height="480" data-position="-20,250" data-in="right" data-delay="500"\n' +
    '          data-out="fade" style="width:auto; height:auto">\n' +
    '\n' +
    ...
    '                <p>Lorem ipsum dolor sit amet, cons adipiscing elit. Aenean commodo ligula eget dolor. Cum sociis natoque penatibus\n' +
    '                  mag dis parturient.</p>\n' +
    ...
    '            <li>\n' +
    '              <a href="#">\n' +
    '                <i class="fa fa-angle-right"></i> Donec convallis, metus nec tempus aliquet</a>\n' +
    '            </li>\n' +
    '            <li>\n' +
    '              <a href="#">\n' +
    '                <i class="fa fa-angle-right"></i> Aenean commodo ligula eget dolor</a>\n' +
    '            </li>\n' +
    '            <li>\n' +
    '              <a href="#">\n' +
    '                <i class="fa fa-angle-right"></i> Cum sociis natoque penatibus mag ipsum</a>\n' +
    '            </li>\n' +
    '            <li>\n' +
    '              <a href="#">\n' +
    '                <i class="fa fa-angle-right"></i> Lorem ipsum dolor sit amet cons adipiscing</a>\n' +
    '            </li>\n' +
    '            <li>\n' +
    '              <a href="#">\n' +
    '                <i class="fa fa-angle-right"></i> Accumsan vulputate faucibus turpis dictum</a>\n' +
    '            </li>\n' +
    '            <li>\n' +
    '              <a href="#">\n' +
    '                <i class="fa fa-angle-right"></i> Nullam ultrices eros accumsan vulputate</a>\n' +
    '            </li>\n' +
    '            <li>\n' +
    '              <a href="#">\n' +
    '                <i class="fa fa-angle-right"></i> Nunc aliquet tincidunt metus sit amet</a>\n' +
    '            </li>\n' +
    '          </ul>\n' +
    '        </div>\n' +
    '\n' +
    ...
    '                  </div>\n' +
    '                  <blockquote>\n' +
    '                    <p>Donec convallis, metus nec tempus aliquet, nunc metus adipiscing leo, a lobortis nisi dui ut odio. Nullam\n' +
    '                      ultrices, eros accumsan vulputate faucibus, turpis tortor dictum.</p>\n' +
    '                  </blockquote>\n' +
    ...
    '                  </div>\n' +
    '                  <blockquote>\n' +
    '                    <p>Metus aliquet tincidunt metus, sit amet mattis lectus sodales ac. Suspendisse rhoncus dictum eros, ut\n' +
    '                      egestas eros luctus eget. Nam nibh sem, mattis et feugiat ut, porttitor nec risus.</p>\n' +
    '                  </blockquote>\n' +
    '                  <div class="testimonial-review">\n' +
    ...
    '                  </div>\n' +
    '                  <blockquote>\n' +
    '                    <p>Nunc aliquet tincidunt metus, sit amet mattis lectus sodales ac. Suspendisse rhoncus dictum eros, ut\n' +
    '                      egestas eros luctus eget. Nam nibh sem, mattis et feugiat ut, porttitor nec risus.</p>\n' +
    '                  </blockquote>\n' +
    '                  <div class="testimonial-review">\n' +
    ...
    '              <a href="#testimonial-carousel" data-slide="prev">\n' +
    '                <i class="fa fa-chevron-left"></i>\n' +
    '              </a>&#32;\n' +
    '              <a href="#testimonial-carousel" data-slide="next">\n' +
    ...
    '            <p>Donec earum rerum hic tenetur ans sapiente delectus, ut aut reiciendise voluptat maiores alias consequaturs aut\n' +
    '              perferendis doloribus asperiores.</p>\n' +
    '            <ul class="contact-details-alt">\n' +
    '              <li>\n' +
    '                <i class="fa fa-map-marker"></i>\n' +
    '                <p>\n' +
    '                  <strong>Address</strong>: #2021 Lorem Ipsum</p>\n' +
    '              </li>\n' +
    '              <li>\n' +
    '                <i class="fa fa-user"></i>\n' +
    '                <p>\n' +
    '                  <strong>Phone</strong>:(+91) 9000-12345</p>\n' +
    '              </li>\n' +
    '              <li>\n' +
    ...
    '      <div class="row">\n' +
    '        <div class="col-lg-6 ">\n' +
    '          <p class="copyright">&copy; Copyright 2014 ISMS | Powered by\n' +
    '            <a href="#">CCIA</a>\n' +
    '          </p>\n' +
    '        </div>\n' +
    '\n' +
    ...
    '              <li>\n' +
    '                <a class="fb" href="#." data-placement="top" data-toggle="tooltip" title="Facbook">\n' +
    '                  <i class="fa fa-facebook"></i>\n' +
    '                </a>\n' +
    '              </li>\n' +
    '              <li>\n' +
    '                <a class="twtr" href="#." data-placement="top" data-toggle="tooltip" title="Twitter">\n' +
    '                  <i class="fa fa-twitter"></i>\n' +
    '                </a>\n' +
    '              </li>\n' +
    '              <li>\n' +
    '                <a class="dribbble" href="#." data-placement="top" data-toggle="tooltip" title="Dribbble">\n' +
    '                  <i class="fa fa-dribbble"></i>\n' +
    '                </a>\n' +
    '              </li>\n' +
    '              <li>\n' +
    '                <a class="skype" href="#." data-placement="top" data-toggle="tooltip" title="Skype">\n' +
    '                  <i class="fa fa-skype"></i>\n' +
    '                </a>\n' +
    '              </li>\n' +
    '              <li>\n' +
    '                <a class="rss" href="#." data-placement="top" data-toggle="tooltip" title="RSS">\n' +
    '                  <i class="fa fa-rss"></i>\n' +
    '                </a>\n' +
    '              </li>\n' +
    '            </ul>\n' +
